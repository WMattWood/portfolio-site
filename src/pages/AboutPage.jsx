          ...
          <SectionContainer>
            {/* <BlurbBox> */}
              <Blurb>I have been using computers to learn, create and explore since I was a kid.  
                ...
                my grandparents' old Macintosh.  Over the past 20 years I've used computers
              ...
              <Blurb>I truly loved working with audio.  However I realized I had reached a limit for what there was to learn.
                I can say with honesty that I achieved mastery in the audio domain, but after solving problems related to all
              ...
              <Blurb>My learning process began with exploring the domain.  I spent several weeks just reading about code, and 
                ...
                the most common languages?  (Java, Javascript, Ruby, Python, C#, C++, C) What is the common software used 
                (VSCode, Atom, Notepad++).  What are the essential skills?  (Git/VCS, Looping, O.O.P, Recursion, 
                Dependency Management)
              </Blurb>

              <Blurb> I spent several months while working at my former job, taking Codecademy courses during the evenings and 
                weekends, and starting to read Hackernews on the regular.  I considered taking a coding bootcamp for many years, but 
              ...
              <Blurb> At the end of 2022, I finally felt ready to attempt a high-paced Bootcamp.  The 12 weeks I spent in the
                Bootcamp were some of the most intense weeks of my life!  By the end of it, I came out with a strong mental model for a 
                modern React based SPA design, as well as a strong comprehension of what goes in to Frontend and Back End elements.  Since 
                the completion of that program I have continued learning on my own, building new projects and expanding my hands on experience 
                while searching for my next role in software development.
              </Blurb>
